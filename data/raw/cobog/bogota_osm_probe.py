...
# ///
"""Freshness probe for Bogotá's OSM staging parquet.

Emits the GCS publication time of cobog_osm_staging.parquet, which only moves
...
STAGING_NAME = "cobog_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("COBOG", modified_at, label="COBOG OSM staging")
