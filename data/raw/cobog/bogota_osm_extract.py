...
"""Extract Bogotá's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run cobog/bogota_osm_extract.py

The scheduled `osm-cobog` [[cloud.job]] is the normal path; this is the manual
