...
# ///
"""Freshness probe for Kelowna's OSM staging parquet.

Emits the GCS publication time of cakel_osm_staging.parquet, which only moves
...
STAGING_NAME = "cakel_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAKEL", modified_at, label="CAKEL OSM staging")
