...
# ///
"""Freshness probe for Washington DC's OSM staging parquet.

Emits the GCS publication time of uswas_osm_staging.parquet, which only
changes when washingtondc_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "uswas_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("USWAS", modified_at, label="USWAS OSM staging")
