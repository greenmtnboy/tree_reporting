...
# ///
"""Freshness probe for Burlington's OSM staging parquet.

Emits the GCS publication time of usbtv_osm_staging.parquet, which only
changes when burlington_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "usbtv_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("USBTV", modified_at, label="USBTV OSM staging")
