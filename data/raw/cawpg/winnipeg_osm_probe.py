...
# ///
"""Freshness probe for Winnipeg's OSM staging parquet.

Emits the GCS publication time of cawpg_osm_staging.parquet, which only moves
...
STAGING_NAME = "cawpg_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAWPG", modified_at, label="CAWPG OSM staging")
