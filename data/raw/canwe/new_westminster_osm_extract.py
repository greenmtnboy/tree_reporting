...
"""Extract New Westminster's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run canwe/new_westminster_osm_extract.py

The scheduled `osm-canwe` [[cloud.job]] is the normal path; this is the manual
