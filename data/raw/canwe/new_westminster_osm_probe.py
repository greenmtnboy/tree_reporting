...
# ///
"""Freshness probe for New Westminster's OSM staging parquet.

Emits the GCS publication time of canwe_osm_staging.parquet, which only moves
...
STAGING_NAME = "canwe_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CANWE", modified_at, label="CANWE OSM staging")
