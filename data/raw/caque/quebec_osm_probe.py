...
# ///
"""Freshness probe for Quebec City's OSM staging parquet.

Emits the GCS publication time of caque_osm_staging.parquet, which only moves
...
STAGING_NAME = "caque_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAQUE", modified_at, label="CAQUE OSM staging")
