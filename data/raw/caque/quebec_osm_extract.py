...
"""Extract Quebec City's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run caque/quebec_osm_extract.py

The scheduled `osm-caque` [[cloud.job]] is the normal path; this is the manual
