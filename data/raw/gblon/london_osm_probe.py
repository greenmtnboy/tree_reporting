...
# ///
"""Freshness probe for London's OSM staging parquet.

Emits the GCS publication time of gblon_osm_staging.parquet, which only
changes when london_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "gblon_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("GBLON", modified_at, label="GBLON OSM staging")
