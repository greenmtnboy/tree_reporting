...
"""Extract Lethbridge's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run calet/lethbridge_osm_extract.py

The scheduled `osm-calet` [[cloud.job]] is the normal path; this is the manual
