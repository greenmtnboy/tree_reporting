...
# ///
"""Freshness probe for Lethbridge's OSM staging parquet.

Emits the GCS publication time of calet_osm_staging.parquet, which only moves
...
STAGING_NAME = "calet_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CALET", modified_at, label="CALET OSM staging")
