...
# ///
"""Freshness probe for San Francisco's OSM staging parquet.

Emits the GCS publication time of ussfo_osm_staging.parquet, which only
changes when sf_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "ussfo_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("USSFO", modified_at, label="USSFO OSM staging")
