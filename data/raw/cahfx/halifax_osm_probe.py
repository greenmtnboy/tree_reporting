...
# ///
"""Freshness probe for Halifax's OSM staging parquet.

Emits the GCS publication time of cahfx_osm_staging.parquet, which only moves
...
STAGING_NAME = "cahfx_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAHFX", modified_at, label="CAHFX OSM staging")
