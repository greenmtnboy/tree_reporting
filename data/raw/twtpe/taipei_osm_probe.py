...
# ///
"""Freshness probe for Taipei's OSM staging parquet.

Emits the GCS publication time of twtpe_osm_staging.parquet, which only moves
...
STAGING_NAME = "twtpe_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("TWTPE", modified_at, label="TWTPE OSM staging")
