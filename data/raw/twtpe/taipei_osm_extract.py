...
"""Extract Taipei's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run twtpe/taipei_osm_extract.py

The scheduled `osm-twtpe` [[cloud.job]] is the normal path; this is the manual
