...
# ///
"""Freshness probe for Ottawa's OSM staging parquet.

Emits the GCS publication time of caott_osm_staging.parquet, which only moves
...
STAGING_NAME = "caott_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAOTT", modified_at, label="CAOTT OSM staging")
