...
"""Extract Ottawa's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run caott/ottawa_osm_extract.py

The scheduled `osm-caott` [[cloud.job]] is the normal path; this is the manual
