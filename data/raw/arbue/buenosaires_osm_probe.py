...
# ///
"""Freshness probe for Buenos Aires's OSM staging parquet.

Emits the GCS publication time of arbue_osm_staging.parquet, which only
changes when buenosaires_osm_extract.py is re-run and its output uploaded.
...
if __name__ == "__main__":
    emit_freshness("ARBUE", modified_at, label="ARBUE OSM staging")
