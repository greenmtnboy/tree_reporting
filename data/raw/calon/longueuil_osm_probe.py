...
# ///
"""Freshness probe for Longueuil's OSM staging parquet.

Emits the GCS publication time of calon_osm_staging.parquet, which only moves
...
STAGING_NAME = "calon_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CALON", modified_at, label="CALON OSM staging")
