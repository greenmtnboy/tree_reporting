...
# ///
"""Freshness probe for Vancouver's OSM staging parquet.

Emits the GCS publication time of cavan_osm_staging.parquet, which only
changes when vancouver_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "cavan_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAVAN", modified_at, label="CAVAN OSM staging")
