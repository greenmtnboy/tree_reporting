...
# ///
"""Freshness probe for Edmonton's OSM staging parquet.

Emits the GCS publication time of caedm_osm_staging.parquet, which only moves
...
STAGING_NAME = "caedm_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAEDM", modified_at, label="CAEDM OSM staging")
