...
# ///
"""Freshness probe for Montreal's OSM staging parquet.

Emits the GCS publication time of camtl_osm_staging.parquet, which only moves
...
STAGING_NAME = "camtl_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAMTL", modified_at, label="CAMTL OSM staging")
