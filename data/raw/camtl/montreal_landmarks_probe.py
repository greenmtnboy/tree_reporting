...
# ///
"""Freshness probe for CAMTL's RPCQ heritage landmarks.

The register arrives as two resources (classified and cited -- see
`montreal_landmarks.py`), and this takes the **later** of their publication
...
if __name__ == "__main__":
    emit_freshness("CAMTL", fetch_modified_at, label="CAMTL landmarks")
