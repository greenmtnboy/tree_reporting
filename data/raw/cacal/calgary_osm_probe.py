...
# ///
"""Freshness probe for Calgary's OSM staging parquet.

Emits the GCS publication time of cacal_osm_staging.parquet, which only moves
...
STAGING_NAME = "cacal_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CACAL", modified_at, label="CACAL OSM staging")
