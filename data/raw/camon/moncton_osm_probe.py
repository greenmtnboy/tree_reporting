...
# ///
"""Freshness probe for Moncton's OSM staging parquet.

Emits the GCS publication time of camon_osm_staging.parquet, which only moves
...
STAGING_NAME = "camon_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAMON", modified_at, label="CAMON OSM staging")
