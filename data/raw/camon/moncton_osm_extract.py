...
"""Extract Moncton's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run camon/moncton_osm_extract.py

The scheduled `osm-camon` [[cloud.job]] is the normal path; this is the manual
