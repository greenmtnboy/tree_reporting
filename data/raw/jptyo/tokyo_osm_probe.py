...
# ///
"""Freshness probe for Tokyo's OSM staging parquet.

Emits the GCS publication time of jptyo_osm_staging.parquet, which only moves
...
STAGING_NAME = "jptyo_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("JPTYO", modified_at, label="JPTYO OSM staging")
