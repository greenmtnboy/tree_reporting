...
# ///
"""Freshness probe for Los Angeles's OSM staging parquet.

Emits the GCS publication time of uslax_osm_staging.parquet, which only
changes when losangeles_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "uslax_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("USLAX", modified_at, label="USLAX OSM staging")
