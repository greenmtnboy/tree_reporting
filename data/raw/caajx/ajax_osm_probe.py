...
# ///
"""Freshness probe for Ajax's OSM staging parquet.

Emits the GCS publication time of caajx_osm_staging.parquet, which only moves
...
STAGING_NAME = "caajx_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CAAJX", modified_at, label="CAAJX OSM staging")
