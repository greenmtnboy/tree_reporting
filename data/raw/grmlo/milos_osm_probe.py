...
# ///
"""Freshness probe for Milos's OSM staging parquet.

Emits the GCS publication time of grmlo_osm_staging.parquet, which only
changes when milos_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "grmlo_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("GRMLO", modified_at, label="GRMLO OSM staging")
