...
# ///
"""Freshness probe for Melbourne's OSM staging parquet.

Emits the GCS publication time of aumel_osm_staging.parquet, which only
changes when melbourne_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "aumel_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("AUMEL", modified_at, label="AUMEL OSM staging")
