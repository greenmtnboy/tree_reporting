...
# ///
"""Freshness probe for Toronto's OSM staging parquet.

Emits the GCS publication time of cator_osm_staging.parquet, which only moves
...
STAGING_NAME = "cator_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("CATOR", modified_at, label="CATOR OSM staging")
