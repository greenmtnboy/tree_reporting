...
# ///
"""Freshness probe for New York City's OSM staging parquet.

Emits the GCS publication time of usnyc_osm_staging.parquet, which only
changes when nyc_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "usnyc_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("USNYC", modified_at, label="USNYC OSM staging")
