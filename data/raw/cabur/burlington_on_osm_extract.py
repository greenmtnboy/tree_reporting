...
"""Extract Burlington, ON's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run cabur/burlington_on_osm_extract.py

The scheduled `osm-cabur` [[cloud.job]] is the normal path; this is the manual
