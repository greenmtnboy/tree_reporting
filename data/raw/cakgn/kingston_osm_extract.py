...
"""Extract Kingston's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run cakgn/kingston_osm_extract.py

The scheduled `osm-cakgn` [[cloud.job]] is the normal path; this is the manual
