...
# ///
"""Freshness probe for Kingston's OSM staging parquet.

Emits the GCS publication time of cakgn_osm_staging.parquet, which only moves
...
if __name__ == "__main__":
    emit_freshness("CAKGN", modified_at, label="CAKGN OSM staging")
