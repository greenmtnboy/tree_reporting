...
# ///
"""Freshness probe for Berlin's OSM staging parquet.

Emits the GCS publication time of deber_osm_staging.parquet, which only
changes when berlin_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "deber_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("DEBER", modified_at, label="DEBER OSM staging")
