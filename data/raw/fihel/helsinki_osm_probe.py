...
# ///
"""Freshness probe for Helsinki's OSM staging parquet.

Emits the GCS publication time of fihel_osm_staging.parquet, which only moves
...
STAGING_NAME = "fihel_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("FIHEL", modified_at, label="FIHEL OSM staging")
