...
# ///
"""Freshness probe for Amsterdam's OSM staging parquet.

Emits the GCS publication time of nlams_osm_staging.parquet, which only
changes when amsterdam_osm_extract.py is re-run and its output uploaded.
...
STAGING_NAME = "nlams_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("NLAMS", modified_at, label="NLAMS OSM staging")
