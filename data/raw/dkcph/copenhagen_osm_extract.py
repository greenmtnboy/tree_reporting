...
"""Extract Copenhagen's OpenStreetMap trees into the staged parquet in GCS.
...
bbox, an extra tag) has somewhere to do it.
    ...
    cd data/raw && uv run dkcph/copenhagen_osm_extract.py

The scheduled `osm-dkcph` [[cloud.job]] is the normal path; this is the manual
