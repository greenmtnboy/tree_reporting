...
# ///
"""Freshness probe for Copenhagen's OSM staging parquet.

Emits the GCS publication time of dkcph_osm_staging.parquet, which only moves
...
STAGING_NAME = "dkcph_osm_staging.parquet"
...
if __name__ == "__main__":
    emit_freshness("DKCPH", modified_at, label="DKCPH OSM staging")
