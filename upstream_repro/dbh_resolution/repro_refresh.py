...
# dependencies = ["pytrilogy==0.3.332"]
# ///
...
Defaults to repro.preql / merged_rows. Drives the same planner the CLI's
...
TARGET = sys.argv[2] if len(sys.argv) > 2 else "merged_rows"
