...
RUNS=['sf-boston-naip-curation-v14-finetune','sf-boston-naip-curation-v15-finetune']
out=ROOT/'benchmarks/v15-v14-goal-aligned-native'
...
lines=['# Goal-aligned F2: v14 vs v15','',
 ...
 '| City | Radius | v14 F2 | v15 F2 | Delta |','|---|---:|---:|---:|---:|']
